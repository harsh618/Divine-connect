const translations = {
  en: {
    ...
    profile: { title: "My Profile", language: "Preferred Language", personalInfo: "Personal Information", fullName: "Full Name", email: "Email", gotra: "Gotra", rashi: "Rashi", favoriteDeity: "Favorite Deity", selectDeity: "Select Deity", selectRashi: "Select Rashi", myStats: "My Spiritual Journey", totalBookings: "Total Bookings", completedPoojas: "Completed Poojas", totalDonations: "Total Donations", quickLinks: "Quick Links", myKundli: "My Kundli", myDonations: "My Donations", savedTemples: "Saved Temples", becomeProvider: "Become a Provider", notAuthenticated: "Please sign in to view your profile" },
    bookings: { title: "My Bookings", upcoming: "Upcoming", completed: "Completed", cancelled: "Cancelled", noBookings: "No bookings yet", startExploring: "Start exploring our services", exploreServices: "Explore Services", templeVisit: "Temple Visit", pooja: "Pooja", consultation: "Consultation", prasad: "Prasad", at: "at", downloadCertificate: "Download Certificate", viewQR: "View QR Code", rateExperience: "Rate your experience" },
    templeDetail: { about: "About", bookVisit: "Book Visit", liveDarshan: "Live Darshan", orderPrasad: "Order Prasad", donate: "Donate", location: "Location", openingHours: "Opening Hours", dressCode: "Dress Code", significance: "Significance", history: "History", upcomingFestivals: "Upcoming Festivals", noFestivals: "No upcoming festivals", bookingModal: { title: "Book Temple Visit", selectDate: "Select Visit Date", selectTime: "Preferred Time Slot", numberOfDevotees: "Number of Devotees", specialRequirements: "Special Requirements", optional: "Optional", proceedToPayment: "Proceed to Payment" }, donationModal: { title: "Make a Donation", amount: "Donation Amount", customAmount: "Custom Amount", anonymous: "Make this donation anonymous", recurring: "Make this a recurring donation", monthly: "Monthly", yearly: "Yearly" } },
    poojas: { title: "Book a Pooja", subtitle: "Experience sacred rituals performed by verified pandits", searchPlaceholder: "Search poojas...", category: "Category", virtualOnly: "Virtual Only", noPoojas: "No poojas available", checkBack: "Check back soon for available pooja services", bookNow: "Book Now", virtual: "Virtual", includes: "Includes", mins: "mins" },
    astrology: { title: "Consult Expert Astrologers", subtitle: "Get personalized guidance from verified astrologers", searchPlaceholder: "Search astrologers...", experience: "Experience", specialization: "Specialization", availability: "Availability", onlineNow: "Online Now", noAstrologers: "No astrologers available", checkBack: "Check back soon", chatNow: "Chat Now", viewProfile: "View Profile", consultationRates: "Consultation Rates", chat: "Chat", voice: "Voice Call", video: "Video Call", perMin: "/min", languages: "Languages", quickQuestion: "Ask a Quick Question", askQuestion: "Ask Your Question", writeQuestion: "Write your question here...", submit: "Submit Question", consultingAstrologers: "Our team of astrologers will respond soon" },
    priests: { title: "Connect with Priests", subtitle: "Experienced priests for poojas and spiritual guidance", searchPlaceholder: "Search priests...", noPriests: "No priests available" },
    donate: { title: "Support Sacred Causes", subtitle: "Your donations help maintain temples and support charitable activities", totalRaised: "Total Raised", activeCampaigns: "Active Campaigns", generousDonors: "Generous Donors", allCauses: "All Causes", noCampaigns: "No campaigns yet", daysLeft: "days left", raised: "Raised", goal: "Goal", completed: "Completed" },
  ...
  hi: {
    ...
    profile: { title: "मेरी प्रोफ़ाइल", language: "पसंदीदा भाषा", personalInfo: "व्यक्तिगत जानकारी", fullName: "पूरा नाम", email: "ईमेल", gotra: "गोत्र", rashi: "राशि", favoriteDeity: "पसंदीदा देवता", selectDeity: "देवता चुनें", selectRashi: "राशि चुनें", myStats: "मेरी आध्यात्मिक यात्रा", totalBookings: "कुल बुकिंग", completedPoojas: "पूर्ण पूजाएं", totalDonations: "कुल दान", quickLinks: "त्वरित लिंक", myKundli: "मेरी कुंडली", myDonations: "मेरे दान", savedTemples: "सहेजे गए मंदिर", becomeProvider: "सेवा प्रदाता बनें", notAuthenticated: "कृपया अपनी प्रोफ़ाइल देखने के लिए साइन इन करें" },
    bookings: { title: "मेरी बुकिंग", upcoming: "आगामी", completed: "पूर्ण", cancelled: "रद्द", noBookings: "अभी तक कोई बुकिंग नहीं", startExploring: "हमारी सेवाओं का अन्वेषण शुरू करें", exploreServices: "सेवाएं देखें", templeVisit: "मंदिर दर्शन", pooja: "पूजा", consultation: "परामर्श", prasad: "प्रसाद", at: "पर", downloadCertificate: "प्रमाण पत्र डाउनलोड करें", viewQR: "QR कोड देखें", rateExperience: "अपने अनुभव को रेट करें" },
    templeDetail: { about: "के बारे में", bookVisit: "दर्शन बुक करें", liveDarshan: "लाइव दर्शन", orderPrasad: "प्रसाद ऑर्डर करें", donate: "दान करें", location: "स्थान", openingHours: "खुलने का समय", dressCode: "ड्रेस कोड", significance: "महत्व", history: "इतिहास", upcomingFestivals: "आगामी त्यौहार", noFestivals: "कोई आगामी त्यौहार नहीं", bookingModal: { title: "मंदिर दर्शन बुक करें", selectDate: "दर्शन तिथि चुनें", selectTime: "पसंदीदा समय स्लॉट", numberOfDevotees: "भक्तों की संख्या", specialRequirements: "विशेष आवश्यकताएं", optional: "वैकल्पिक", proceedToPayment: "भुगतान के लिए आगे बढ़ें" }, donationModal: { title: "दान करें", amount: "दान राशि", customAmount: "कस्टम राशि", anonymous: "इस दान को गुमनाम बनाएं", recurring: "इसे आवर्ती दान बनाएं", monthly: "मासिक", yearly: "वार्षिक" } },
    poojas: { title: "पूजा बुक करें", subtitle: "सत्यापित पंडितों द्वारा किए गए पवित्र अनुष्ठानों का अनुभव करें", searchPlaceholder: "पूजा खोजें...", category: "श्रेणी", virtualOnly: "केवल वर्चुअल", noPoojas: "कोई पूजा उपलब्ध नहीं", checkBack: "उपलब्ध पूजा सेवाओं के लिए जल्द ही वापस जांचें", bookNow: "अभी बुक करें", virtual: "वर्चुअल", includes: "शामिल है", mins: "मिनट" },
    astrology: { title: "विशेषज्ञ ज्योतिषियों से परामर्श लें", subtitle: "सत्यापित ज्योतिषियों से व्यक्तिगत मार्गदर्शन प्राप्त करें", searchPlaceholder: "ज्योतिषी खोजें...", experience: "अनुभव", specialization: "विशेषज्ञता", availability: "उपलब्धता", onlineNow: "अभी ऑनलाइन", noAstrologers: "कोई ज्योतिषी उपलब्ध नहीं", checkBack: "जल्द ही वापस जांचें", chatNow: "अभी चैट करें", viewProfile: "प्रोफ़ाइल देखें", consultationRates: "परामर्श दरें", chat: "चैट", voice: "वॉयस कॉल", video: "वीडियो कॉल", perMin: "/मिनट", languages: "भाषाएं", quickQuestion: "त्वरित प्रश्न पूछें", askQuestion: "अपना प्रश्न पूछें", writeQuestion: "अपना प्रश्न यहां लिखें...", submit: "प्रश्न सबमिट करें", consultingAstrologers: "हमारे ज्योतिषियों की टीम जल्द ही जवाब देगी" },
    priests: { title: "पुजारियों से जुड़ें", subtitle: "पूजा और आध्यात्मिक मार्गदर्शन के लिए अनुभवी पुजारी", searchPlaceholder: "पुजारी खोजें...", noPriests: "कोई पुजारी उपलब्ध नहीं" },
    donate: { title: "पवित्र कारणों का समर्थन करें", subtitle: "आपके दान से मंदिरों का रखरखाव और धर्मार्थ गतिविधियों में मदद मिलती है", totalRaised: "कुल एकत्रित", activeCampaigns: "सक्रिय अभियान", generousDonors: "उदार दाताओं", allCauses: "सभी कारण", noCampaigns: "अभी तक कोई अभियान नहीं", daysLeft: "दिन शेष", raised: "एकत्रित", goal: "लक्ष्य", completed: "पूर्ण" },
    languages: { en: "English", hi: "हिन्दी (Hindi)", ta: "தமிழ் (Tamil)", te: "తెలుగు (Telugu)", bn: "বাংলা (Bengali)", mr: "मराठी (Marathi)", gu: "ગુજરાતી (Gujarati)", kn: "ಕನ್ನಡ (Kannada)", ml: "മലയാളം (Malayalam)", pa: "ਪੰਜਾਬੀ (Punjabi)", or: "ଓଡ଼ିଆ (Odia)", as: "অসমীয়া (Assamese)", ur: "اردو (Urdu)", sa: "संस्कृत (Sanskrit)", kok: "कोंकणी (Konkani)", mni: "মৈতৈলোন (Manipuri)" }
  },
  ta: {
