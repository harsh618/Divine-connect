...
function LayoutContent({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Desktop Navigation */}
      <nav className="bg-white/95 opacity-100 fixed top-0 left-0 right-0 z-50 backdrop-blur-md shadow-sm border-b border-gray-100">
        <div className="container mx-auto px-6">
          <div className="opacity-100 flex items-center justify-between h-16">
            {/* Logo */}
